...
%folderName = 'gamma beta 6+1 inputs quadrature rule study';
...
if mat_geo_coupled
    ...
    if save_outputs
        ...
        save(['rho_soft_gamma_' num2str(materials_size(2)) 'd_fp_5%_n' num2str(length(rho_soft))], 'rho_soft');
        ...
        save(['pr_hard_gamma_' num2str(materials_size(2)) 'd_fp_5%_n' num2str(length(pr_hard))], 'pr_hard');
